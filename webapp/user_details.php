           ...
           document.getElementById("loading").style.visibility = "visible";
            $.ajax({
               ...
               success: function(data) {
                   //show content
                   objes = JSON.parse(data)
                   rows = "<div id='events'><input class='form-control' placeholder='Search for...'/><table class='table'><thead><tr><th><b>Index</b></th><th><b>Event Id</b></th><th><b>Latitude</b></th><th><b>Longitude</b></th><th><button class='sort btn btn-secondary btn-lg' data-sort='time'><b>Time</b></button></th></tr></thead><tbody class='list'>";
                   var i = 1;
                   for (var event in objes) {
